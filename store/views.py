...
class OrderSummaryView(LoginRequiredMixin, View):
    ...
    def get(self, *args, **kwargs):
        try:
            ...
            return render(self.request, "store/order_summary.html", context=context)
    ...
    if item:
        ...
        if order_qs.exists():
            ...
            if order.items.filter(item__slug=item.slug).exists():
                ...
                return redirect("store:store-product", slug=slug)
            else:
                # add a message saying that order doens't contain this item
                messages.info(request, "Item was not in your cart")
                return redirect("store:store-product", slug=slug)
        else:
            # add a message saying that user doens't have an order
